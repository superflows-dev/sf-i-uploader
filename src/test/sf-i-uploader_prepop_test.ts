...
suite('sf-i-uploader > basics', () => {
  ...
  test('prepop render 1', async () => {
    ...
    test('prepop render 2', async () => {
        ...
        const el = (await fixture(htmlContent2)) as SfIUploader;
        await el.updateComplete;
    ...
    test('prepop render 3', async () => {
        ...
        const el = (await fixture(htmlContent3)) as SfIUploader;
        await el.updateComplete;
    ...
    test('prepop set success', async () => {
        ...
        assert.equal((el.shadowRoot!.querySelector('.div-row-success') as HTMLDivElement).style.display, "flex");
    ...
    test('prepop update progress', async () => {
        ...
        const el = (await fixture(htmlContent4)) as SfIUploader;
        await el.updateComplete;
        ...
        assert.equal((el.shadowRoot!.querySelector('#progress-bar-left-0') as HTMLDivElement).style.width, "49%");
    ...
    test('prepop update render key data img', async () => {
        ...
        assert.equal((el.shadowRoot!.querySelector('#detail-container') as HTMLDivElement).style.display, "block");
    ...
    test('prepop update render key data pdf', async () => {
        ...
        assert.ok((el.shadowRoot!.querySelector('#detail-container') as HTMLDivElement).innerHTML.indexOf('File is ready for download') >= 0)
        assert.equal((el.shadowRoot!.querySelector('#detail-container') as HTMLDivElement).style.display, "block");
    ...
    test('clear uploads', async () => {
        ...
        const el = (await fixture(htmlContent5)) as SfIUploader;
        await el.updateComplete;
