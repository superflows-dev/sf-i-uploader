declare const exportFunctions: {
    ...
    uploadMeta: (key: string, filename: string, ext: string, numblocks: string, apiId: string, _SfLoader: any, callbackError: any, projectId: string) => Promise<void>;
    ...
    largeFileWarning: (fileSize: string, apiId: string, _SfLoader: any, callbackError: any, projectId: string) => Promise<void>;
};
